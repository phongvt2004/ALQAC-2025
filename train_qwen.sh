...
--step 500 --round 2 --saved_model qwen_zalo_saved_model --pair_eval_path pair_data_zalo/bm_25_pairs_top50 \
--pair_data_path pair_data_zalo/bm_25_pairs_top10 --batch_size 4 --data_path ALQAC_2025_data/additional_data/zalo --zalo \
