python train_sentence_transformer.py --pretrained_model Qwen/Qwen3-Embedding-4B \
--step 200 --round 2 --saved_model qwen_zalo_saved_model --pair_eval_path pair_data/bm_25_pairs_top50 \
--pair_data_path pair_data_zalo/bm_25_pairs_top50 --batch_size 8 --data_path ALQAC_2025_data/additional_data/zalo --zalo \
