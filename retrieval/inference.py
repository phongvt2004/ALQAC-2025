...
def inference(args, data, models, emb_legal_data, bm25, doc_refers, question_embs, rerank_range_score, retrieve_range_scores = 10, reranker = None, tokenizer = None, others = None):
    results = []
    full_results = []
    law_mapping = {}
    ...
    for idx, item in tqdm(enumerate(data), total=len(data)):
        ...
        #     prompt = f"Question: {question}\nPredictions: {predictions}\nThis is outputs from a legal document retrieval system. Remove any irrelevant or unnecessary articles and return a list of true predictions in the format: [{{'law_id': '...', 'article_id': '...'}}]. If do not have any relevant articles, return a best match prediction."
...
if __name__ == "__main__":
    ...
    pred_list = []
    inference(args, data, model_names, emb_legal_data, bm25, doc_refers, question_embs, rerank_range_score, retrieve_range_score, reranker, tokenizer, others)
